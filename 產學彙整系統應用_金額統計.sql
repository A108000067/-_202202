...
(
SELECT  [PPS_Research_TYPE_認列類別].[認列類別ID],  SUBSTRING(PPS_Research_TABLE_AchievementPeople.cHCode,13,2)  AS 二級單位 ,PPS_Research_TABLE_AchievementPeople.[cUnit], PPS_Research_TYPE_Department.cName AS 單位
,SUM(PPS_Research_TABLE_AchievementPeople.iUnitPercentMoney) AS 績效分配金額
...
GROUP BY [PPS_Research_TYPE_認列類別].[認列類別ID], SUBSTRING(PPS_Research_TABLE_AchievementPeople.cHCode,13,2) ,PPS_Research_TABLE_AchievementPeople.[cUnit], PPS_Research_TYPE_Department.cName
